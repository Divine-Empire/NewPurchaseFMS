...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 18, marginBottom: 20, textAlign: 'center', fontWeight: 'bold', color: '#1f2937' },
  ...
  tableCellHeader: { fontSize: 10, fontWeight: 'bold', color: '#4b5563' },
  tableCell: { fontSize: 9, color: '#1f2937' },
  bgHeader: { backgroundColor: '#f9fafb' },
      ...
      <Page size="A4" style={styles.page} orientation="landscape">
        ...
        {Object.entries(groupedDetailedData).map(([stageName, itemsArray], idx) => {
          ...
          <View key={idx} style={styles.section}>
            <Text style={styles.stageHeader}>{String(stageName)} ({String(items.length)} Overdue)</Text>
            <View style={styles.table}>
